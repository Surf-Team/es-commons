...
public abstract class TCPServer
{
    ...
    LimitedLog userLoopFailed = new LimitedLog(60000, "UserLoopFailed");
    // private
    private int maxId = 0;
    private long lastService = System.currentTimeMillis();
    private boolean running = false;
    protected byte[] lineFeed;
    ...
    public class User
    {
        ...
        public boolean processStreamAfterRequest;
        Socket socket;
        //BufferedReader in;
        PrintWriter out;
    ...
    protected abstract void receivedBytes(User user, byte[] readBuffer, int len);
